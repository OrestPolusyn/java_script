...
class Hamburger {
  ...
  calculatePrice() {
    ...
    let priceStuffings = Hamburger.STUFFINGS[this._stuffing].price;
    let priceToppings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].price + acc, 0);
    return priceSize + priceStuffings + priceToppings; 
   }
   ...
   */
  calculateCalories() { 
    let caloSize = Hamburger.SIZES[this._size].calories;
    let caloStuffings = Hamburger.STUFFINGS[this._stuffing].calories;
    let caloToppings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
    return caloSize + caloStuffings + caloToppings; 
